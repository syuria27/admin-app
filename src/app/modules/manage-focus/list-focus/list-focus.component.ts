...
export class ListFocusComponent implements OnInit {
  ...
  public columns: Array<any> = [
    ...
    { title: 'Nama Focus', name: 'nama_focus', className: ['text-center'] },
  ...
  public onEdit(data: any): void {
    ...
    this.router.navigate(['/manage-focus', 'edit-focus', data.row.kode_focus]);
  }
  ...
  getFocuses() {
    this.loading = true;
    this.focusService.getAllFocuses()
      .subscribe(prods => {
        this.data = prods;
